<x-app-layout>
    ...
    <form action="{{ route('gtc.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div>
        ...
        <div>
            <label for="input_220VAC">Input 220VAC:</label>
            <input type="text" name="input_220VAC" value="{{ old('input_220VAC') }}">
        </div>

        <div>
            <label for="input_24VDC">Input 24VDC:</label>
            <input type="text" name="input_24VDC" value="{{ old('input_24VDC') }}">
        </div>
