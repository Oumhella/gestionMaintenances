...
<div class="container">
    ...
    @if($commonData->form_type === 'gtc' && $commonData->gtcData->isNotEmpty())
        <div class="card">
            <div class="card-header">Sous-station GTC Details</div>
            <div class="card-body">
                <table class="table table-bordered">
                    ...
                    <tbody>
                    @foreach($commonData->gtcData as $task)
                        <tr>
                ...
                <div id="in">
                    @if($commonData->gtcData->isNotEmpty())
                        <p ><strong id="tst">Mesure de l'alimentation 220VAC: </strong> {{ $commonData->gtcData->first()->input_220VAC }}</p>
                        <p><strong id="tst"> Mesure de l'alimentation 24VDC:  </strong> {{ $commonData->gtcData->first()->input_24VDC }}</p>
                    @endif
                </div>
            </div>
        </div>
